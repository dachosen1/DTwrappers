...
test_that("dt.count works", {
  ...
  expect_equal(dt.count1$Region, as.factor(c("Midwest","Midwest","Northeast","Northeast","South","South","West","West")))
  expect_equal(dt.count1$Gender, as.factor(c("Female", "Male","Female", "Male","Female", "Male","Female", "Male")))
  expect_equal(dt.count1$N, c(2139,2093,3588,3335,1679,1541,4278,4347))
  expect_equal(dt.count2$Region, as.factor(c("Midwest","Midwest","Northeast","Northeast","South","South","West","West")))
  expect_equal(dt.count2$Gender, as.factor(c("Female", "Male","Female", "Male","Female", "Male","Female", "Male")))
